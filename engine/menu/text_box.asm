...
TextBoxTextAndCoordTable:
	...
	db 14,10,19,14 ; text box coordinates
	dw UseTossText
	db 16,11 ; text coordinates
	...
	db 9,12,19,17  ; text box coordinates
	dw BattleMenuText
	db 11,14 ; text coordinates
...
; Format: [Move id], [name index]
; Move id = id of move
; Name index = index of name in FieldMoveNames
FieldMoveDisplayData:
	db CUT, $01
	db FLY, $02
	db $B4, $03 ; unused field move
	db SURF, $04
	db STRENGTH, $05
	db FLASH, $06
	db DIG, $07
